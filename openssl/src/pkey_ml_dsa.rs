...
impl Variant {
    ...
    /// OpenSSL `KeyType` for provider-based raw key import (`EVP_PKEY_*_ex`).
    #[cfg(ossl350)]
    pub(crate) fn openssl_key_type(&self) -> crate::pkey::KeyType {
        match self {
            Variant::MlDsa44 => crate::pkey::KeyType::ML_DSA_44,
            Variant::MlDsa65 => crate::pkey::KeyType::ML_DSA_65,
            Variant::MlDsa87 => crate::pkey::KeyType::ML_DSA_87,
        }
    }
...
mod tests {
    ...
    fn test_ml_dsa_nist_siggen_44() {
        ...
        let key = PKey::private_key_from_raw_bytes_ex(None, KeyType::ML_DSA_44, None, &sk).unwrap();
    ...
    fn test_generate(variant: Variant) {
        ...
        let key_pub = PKey::<Public>::public_key_from_raw_bytes_ex(
            None,
            variant.openssl_key_type(),
            None,
            key_pub_bytes,
        )
        .unwrap();
...
mod tests_boringssl {
    ...
    fn test_generate(variant: Variant) {
        ...
        // TODO: Add verification once we implement verify() for BoringSSL
    }
