...
extern "C" {
    ...
    // Parse public key functions
    pub fn MLDSA44_parse_public_key(public_key: *mut MLDSA44_public_key, cbs: *mut CBS) -> c_int;

    pub fn MLDSA65_parse_public_key(public_key: *mut MLDSA65_public_key, cbs: *mut CBS) -> c_int;

    pub fn MLDSA87_parse_public_key(public_key: *mut MLDSA87_public_key, cbs: *mut CBS) -> c_int;
}
...
// CBS (Crypto Byte String) for parsing byte strings
#[repr(C)]
pub struct CBS {
    pub data: *const u8,
    pub len: size_t,
